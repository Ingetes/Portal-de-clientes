    ...
    <header className="w-full sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-white/70 border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <img src="/mnt/data/LOGO-INGETES%20HD.png" alt="INGETES" className="h-10 w-auto" onError={(e)=>{ const t=e.currentTarget; if(t.dataset.fbk!=='1'){ t.dataset.fbk='1'; t.src='./LOGO-INGETES%20HD.png'; } }} />
